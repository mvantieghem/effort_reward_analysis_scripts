---
title: "make covariates for whole brain models"
...
# 12 potential subjects to exclude 
nrow(outlier_df)
...
write.table(covariates_ECA, file = paste0("covariate_files/COMP_ECA_covariates_N", N_subs, ".txt"), quote = F, row.names = F, col.names = F)

write.table(covariates_ECA_full, file = paste0("covariate_files/COMP_ECA_covariates_full_mod_N", N_subs,".txt"), quote = F, row.names = F, col.names = F)
