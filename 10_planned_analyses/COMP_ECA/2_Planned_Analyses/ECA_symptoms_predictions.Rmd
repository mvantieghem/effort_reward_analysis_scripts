...
```{r}
# note, not re-reunning because p-values will be different each time! 
...
load("model_results/motivation_mediates_ECA_symptoms.Rdata")

summary(motiv_mediation1)
#save(motiv_mediation1, file = "model_results/motivation_mediates_ECA_symptoms.Rdata")
```
...
#save(motiv_mediation2, file = "model_results/motivation_mediates_ECA_symptoms.Rdata")
```
