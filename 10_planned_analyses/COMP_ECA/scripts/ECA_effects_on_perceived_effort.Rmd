...
# ECA effects on perceived effort: 
...
perceived_effort_mod_gxa <- lmer(perceived_effort_rating ~ condition + GROUP_ECA*AGE.c + SEX.c +  
                               #     Reinforce_rate.c +  motor_speed_by_condition + 
                              # diff_pos_affect + perceived_reinforce + perceived_control +
                               (1 | SUBJECTID), 
                           data = perceived_df)
...
ggsave(plot_effect, file = "figures/perceived_effort/perceived_effort_by_condition.png", width = 2.5, height = 4)
...
```{r}
perceived_effort_mod_cxa <- lmer(perceived_effort_rating ~ condition*AGE.c + GROUP_ECA + SEX.c +
                                    Reinforce_rate.c +  motor_speed_by_condition + 
                               (1 | SUBJECTID), 
                           data = perceived_df)
