---
title: "specification curves for mPFC to setbacks"
...
setback_outliers <- FB_outlier_subjects %>% 
  filter(ROI == "mPFC" & contrast == "setback")
...
```{r}
FB_df3 <- FB_df2 %>%
  filter(contrast == "setback" & ROI == "mPFC")  %>% 
...
ggsave(wt, file = "../figures/specification_curves/mPFC_setbacks_by_PC1.png", height = 8, width  = 20)
```
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/mPFC_setbacks_by_motivation.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/mPFC_setbacks_by_perceived_effort.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/mPFC_setbacks_by_perceived_reinforce.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/mPFC_setbacks_by_frustration.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/mPFC_setbacks_by_perceived_control.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/mPFC_setbacks_by_diff_pos_affect.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/mPFC_setbacks_by_AGE.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/mPFC_setbacks_by_motion.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/mPFC_setbacks_by_Fam_inc_needs.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/mPFC_setbacks_by_IQ.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/mPFC_setbacks_by_actual_reinforcement.png", height = 8, width  = 20)
