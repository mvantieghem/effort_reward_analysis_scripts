---
title: "specification curves for ACC for Hard- Easy choices"
...
ggsave(wt, file = "../figures/specification_curves/ACC_hard-easy_choice_by_PC1.png", height = 8, width  = 20)
```
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/ACC_hard-easy_choice_by_motivation.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/ACC_hard-easy_choice_by_perceived_effort.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/ACC_hard-easy_choice_by_perceived_reinforce.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/ACC_hard-easy_choice_by_frustration.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/ACC_hard-easy_choice_by_perceived_control.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/ACC_hard-easy_choice_by_diff_pos_affect.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/ACC_hard-easy_choice_by_AGE.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/ACC_hard-easy_choice_by_motion.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/ACC_hard-easy_choice_by_Fam_inc_needs.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/ACC_hard-easy_choice_by_IQ.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/specification_curves/ACC_hard-easy_choiceby_actual_reinforcement.png", height = 8, width  = 20)
