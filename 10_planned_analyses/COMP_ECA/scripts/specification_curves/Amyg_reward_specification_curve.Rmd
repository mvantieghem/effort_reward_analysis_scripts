...
ggsave(wt, file = "../figures/targeted_SCA/Amyg_rewards_by_perceived_reinforce.png", height = 8, width  = 10)
```
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/targeted_SCA/Amyg_rewards_by_PC1.png", height = 8, width  = 10)
```
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/targeted_SCA/Amyg_rewards_by_frustration.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/targeted_SCA/Amyg_rewards_by_lose_feeling.png", height = 8, width  = 10)
```
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/targeted_SCA/Amyg_rewards_by_AGE.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/targeted_SCA/Amyg_rewards_by_motion.png", height = 8, width  = 20)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/targeted_SCA/Amyg_reward_by_actual_reinforcement.png", height = 8, width  = 20)

```



# perceived Reinforce rate mediates age on amyg? 
```{r}
pr_mod_age <- lm(perceived_reinforce ~ AGE.c + total_TRs_censored.c, 
                 data = FB_df4)
summary(pr_mod_age)

amyg_reward_mod_age_pr <- lm(beta ~ perceived_reinforce +
