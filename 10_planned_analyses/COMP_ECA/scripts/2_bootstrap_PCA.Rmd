...
save(bootFrame, file = 'output/pcaBootstrap.rda')
```
...
save(pcaFull, file = 'output/pcaFullSampleModel.rda')
save(pcaFullSample, file = 'output/pcaFullSample.rda')
...
save(pcaFullScores, file = 'output/pcaFullScoresKey.rda')
```
