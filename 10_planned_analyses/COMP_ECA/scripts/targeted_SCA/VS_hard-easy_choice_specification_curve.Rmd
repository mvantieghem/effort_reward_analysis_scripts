---
title: "specification curves for VS response to choices "
...
ggsave(wt, file = "../figures/targeted_SCA/VS_hard-easy_choice_by_frustrated.png", height = 6, width = 8)
```
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/targeted_SCA/VS_hard-easy_choice_by_PC1.png", height = 6, width = 8)
```
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/targeted_SCA/VS_hard-easy_choice_by_perceived_reinforce.png", height = 6, width = 8)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/targeted_SCA/VS_hard-easy_choice_by_AGE.png", height = 6, width = 8)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/targeted_SCA/VS_hard-easy_choice_by_motion.png", height = 6, width = 8)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/targeted_SCA/VS_hard-easy_choice_by_actual_reinforcement.png", height = 6, width = 8)

```



# plot effect of frustration on VS to hard-easy choices
```{r}
VS_hard_Easy_choice_mod_pe <- lm(beta ~  PC1_log.c + frustrated +
                        perceived_reinforce + 
                        AGE.c  + total_TRs_censored.c +  Reinforce_rate.c, 
              data = choice_df2)
summary(VS_hard_Easy_choice_mod_pe)
```

plot effect
```{r}
effect_df <- data.frame(effect("frustrated",VS_hard_Easy_choice_mod_pe))
...
effect_plot <- ggplot(data = effect_df, aes(x = frustrated, y = fit)) + 
  ...
  ylab("VS recruitment for Hard > Easy ") + xlab("frustrated")

effect_plot
ggsave(effect_plot, file = "../figures/targeted_SCA/VS_hard-easy_choice_by_frustration_effect_plot.png", 
       height = 4, width = 4)
```
