---
title: "specification curves for VS Reward reactivity"
...
with(FB_df4, cor.test(frustrated, AGE.c))
with(FB_df4, cor.test(frustrated, perceived_reinforce))
# not 
with(FB_df4, cor.test(frustrated, win_feeling))
with(FB_df4, cor.test(frustrated, lose_feeling))

with(FB_df4, cor.test(frustrated, perceived_control))
with(FB_df4, cor.test(frustrated, perceived_effort_ave))

with(FB_df4, cor.test(frustrated, total_TRs_censored.c))
with(FB_df4, cor.test(frustrated, Reinforce_rate.c))
with(FB_df4, cor.test(frustrated, PC1_log.c))
with(FB_df4, cor.test(frustrated, median_motor_RT_ave))
```
...
ggsave(wt, file = "../figures/targeted_SCA/vmPFC_reward_by_frustration.png", height = 6, width  = 8)
```
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/targeted_SCA/vmPFC_reward_by_PC1.png", height = 6, width = 8)
```
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/targeted_SCA/vmPFC_reward_by_perceived_reinforce.png", height = 6, width = 8)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/targeted_SCA/vmPFC_reward_by_AGE.png", height = 6, width = 8)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/targeted_SCA/vmPFC_reward_by_motion.png", height = 6, width = 8)
