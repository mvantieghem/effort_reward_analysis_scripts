...
with(FB_df4, cor.test(perceived_reinforce, PC1_log.c))
with(FB_df4, cor.test(perceived_reinforce, median_motor_RT_ave))
...
ggsave(wt, file = "../figures/targeted_SCA/VS_reward_by_perceived_reinforce.png", height = 6, width  = 8)
```
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/targeted_SCA/VS_reward_by_lose_feeling.png", height = 6, width = 8)
...
# join panels
(wt = cowplot::plot_grid(top, bottom, ncol = 1, align = "v", labels = c('A', 'B')))
ggsave(wt, file = "../figures/targeted_SCA/VS_reward_by_frustrated.png", height = 6, width = 8)
```
